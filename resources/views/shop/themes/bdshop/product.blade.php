                ...
                <form action="{{$baseUrl.'/checkout/'.$product->slug}}" method="GET" class="space-y-5 flex-1 flex flex-col">
                    ...
                    <div>
                        ...
                        <div class="flex gap-2 flex-wrap">
                            ...
                            <label class="cursor-pointer">
                                ...
                                <span class="block px-4 py-2 rounded-lg border border-slate-200 text-sm font-semibold peer-checked:bg-primary peer-checked:text-white peer-checked:border-primary hover:border-primary/50 transition">{{$c}}</span>
                            </label>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex gap-2 flex-wrap">
                            ...
                            <label class="cursor-pointer">
                                ...
                                <span class="block w-12 h-10 flex items-center justify-center rounded-lg border border-slate-200 text-sm font-bold peer-checked:bg-primary peer-checked:text-white peer-checked:border-primary hover:border-primary/50 transition">{{$s}}</span>
                            </label>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 pt-4 mt-auto">
                        ...
                        @else
                            ...
                            <button type="submit" class="flex-1 py-3.5 bg-primary text-white rounded-lg font-bold text-sm uppercase tracking-wider hover:bg-primary/90 transition shadow-md hover:shadow-lg flex items-center justify-center gap-2">
