...
<div class="max-w-[100rem] mx-auto px-4 sm:px-12 py-16 md:py-24" x-data="{ 
    ...
    <div class="flex flex-col lg:flex-row gap-16 lg:gap-24 transition-all duration-[2.5s] ease-out delay-300" :class="show ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'">
        ...
        <div class="w-full lg:w-7/12">
            <form action="{{$baseUrl.'/checkout/process'}}" method="POST" class="space-y-16 pb-12">
                @csrf
        ...
        <div class="w-full lg:w-5/12">
            <div class="bg-surface/80 backdrop-blur-xl p-8 md:p-14 sticky top-32 border border-white/5 shadow-2xl shadow-black/50">
                ...
                <div class="space-y-6 text-[10px] font-bold uppercase tracking-[0.2em] text-gray-500 pt-10 border-t border-white/5">
                    ...
                    <div class="flex justify-between">
                        <span>Transit</span>
                        <span class="text-gray-300 font-light text-xs tracking-widest">৳<span x-text="delivery"></span></span>
                    </div>
