    ...
    <div class="flex flex-col lg:flex-row gap-0 lg:gap-6 mb-8 mt-4">
        ...
        <div class="flex-1 flex flex-col md:flex-row gap-4">
            ...
            <div class="flex-1 bg-yellow-50 relative overflow-hidden group cursor-pointer border border-gray-100 flex items-center justify-center p-8 min-h-[300px] md:min-h-[400px]">
                <img src="{{ $client->banner ? asset('storage/'.($client->widgets['hero_banner']['image'] ?? $client->banner ?? '')) : 'https://images.unsplash.com/photo-1596462502278-27bf85033e5a?auto=format&fit=crop&w=800&q=80' }}" class="absolute inset-0 w-full h-full object-cover opacity-30 group-hover:scale-105 transition duration-700" loading="lazy">
