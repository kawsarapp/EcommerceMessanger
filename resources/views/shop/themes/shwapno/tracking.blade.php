...
<div class="max-w-[800px] mx-auto px-4 py-16 lg:py-24">
    ...
    <div class="bg-white border border-gray-100 shadow-sm rounded-lg p-8 sm:p-12 mb-8 relative overflow-hidden">
        ...
        <div class="relative z-10 text-center mb-10">
            ...
            <p class="text-sm text-gray-500 max-w-md mx-auto">Enter the 11-digit mobile number associated with your grocery order to see real-time updates.</p>
        </div>
        ...
        <div class="max-w-md mx-auto relative z-10">
            <form method="GET" class="flex flex-col sm:flex-row gap-3">
                ...
                <button type="submit" class="bg-swred hover:bg-[#c8161c] text-white px-8 py-3.5 rounded-full font-bold text-sm transition shadow-md whitespace-nowrap">
                    <i class="fas fa-search mr-1.5 opacity-80"></i> Locate
                </button>
            </form>
        </div>
    </div>
    ...
    <div class="animate-fade-in">
        <h4 class="text-xs font-bold text-gray-500 uppercase tracking-widest mb-6">Showing results for <span class="text-swred">{{ request('phone') }}</span></h4>
        ...
        @empty
            <div class="bg-gray-50 border border-gray-200 rounded-lg p-10 text-center">
                ...
                <h3 class="text-[15px] font-bold text-gray-700 mb-1">No Orders Found</h3>
                <p class="text-[12px] text-gray-500 max-w-xs mx-auto">We couldn't find any recent orders linked to <span class="font-bold border-b border-gray-300 pb-0.5">{{ request('phone') }}</span>.</p>
            </div>
        @endforelse
    </div>
    @endif
