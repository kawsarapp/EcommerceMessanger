            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12">
                ...
                <div class="md:col-span-7 lg:col-span-5 flex flex-col">
                    ...
                    <form action="{{$baseUrl.'/checkout/'.$product->slug}}" method="GET" class="space-y-6 mt-auto">
                        ...
                        @if($product->colors)
                        <div>
                            <span class="text-gray-500 text-sm font-medium mr-4">Color Family</span>
                        ...
                        @if($product->sizes)
                        <div>
                            <span class="text-gray-500 text-sm font-medium mr-4">Size</span>
                            <div class="flex gap-2 flex-wrap mt-2">
                        ...
                        <div class="flex gap-3 pt-6">
                            @if(isset($product->stock_status) && $product->stock_status == 'out_of_stock')
                                <button type="button" disabled class="flex-1 bg-gray-300 text-gray-500 py-3 rounded font-bold uppercase cursor-not-allowed">Out of Stock</button>
                            @else
                                <button type="submit" class="flex-1 bg-[#2ABBE8] hover:bg-[#1d9fc9] text-white py-3 rounded text-sm font-bold transition shadow-sm">Buy Now</button>
                                <button type="button" class="flex-1 bg-primary hover:bg-[#d04000] text-white py-3 rounded text-sm font-bold transition shadow-sm"><i class="fas fa-shopping-cart mr-2"></i>Add to Cart</button>
                            @endif
                        </div>
                    </form>
                </div>
                ...
                <div class="hidden lg:block lg:col-span-3">
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                        <div class="text-xs font-bold text-gray-500 mb-4 uppercase tracking-wider">Delivery Options</div>
                        ...
                        <div class="flex justify-between items-start mb-4">
                            <div class="flex gap-3">
                                ...
                                <div>
                                    <div class="text-sm font-bold text-gray-800">Standard Delivery</div>
                        ...
                        <div class="flex gap-3 mb-4">
                            ...
                            <div class="text-sm text-gray-700">Cash on Delivery Available</div>
                        </div>

                        <hr class="border-gray-200 my-4">
                        
                        <div class="text-xs font-bold text-gray-500 mb-4 uppercase tracking-wider">Return & Warranty</div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 mt-6">
            <div class="lg:col-span-3 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <h2 class="text-lg font-bold text-gray-900 mb-4 border-b border-gray-100 pb-2">Product Details of {{$product->name}}</h2>
            ...
            <div class="lg:col-span-1 border border-gray-200 rounded-xl bg-white p-4 hidden lg:block">
                <h3 class="font-bold text-gray-900 mb-4 text-sm uppercase">You May Also Like</h3>
