        ...
        @forelse($products as $p) 
            <a href="{{$baseUrl.'/product/'.$p->slug}}" class="group flex flex-col bg-white rounded-[2.5rem] border-4 border-transparent hover:border-primary/20 overflow-hidden shadow-cloud hover:shadow-float transform hover:-translate-y-2 transition-all duration-300 relative">
                ...
                <div class="aspect-[4/5] bg-slate-50 relative p-6 flex items-center justify-center overflow-hidden w-full">
                    ...
                    <img src="{{asset('storage/'.$p->thumbnail)}}" class="max-w-[85%] max-h-[85%] object-contain mix-blend-multiply z-10 transform group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500 ease-out">
                </div>
