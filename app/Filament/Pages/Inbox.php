<x-filament-panels::page>
    <div class="flex flex-col md:flex-row h-[82vh] bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800 overflow-hidden" wire:poll.3s="loadChat">
