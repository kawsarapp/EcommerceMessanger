...
use App\Filament\Resources\ClientResource\Schemas\Tabs\LogisticsTab;
            ...
            public static function canAccess(array $parameters = []): bool
    {
        ...
        if ($client) {
            ...
            if ($client->plan) {
                ...
                if (is_array($planHiddenMenus) && in_array('logistics', $planHiddenMenus)) {
            ...
            if (is_array($hiddenMenus) && in_array('logistics', $hiddenMenus)) {
                return false; // Menu is hidden specifically for this client
            }
        }

        if ($user->role === 'staff') {
            return $user->hasStaffPermission('manage_logistics');
        }
