...
class EditStorefrontBody extends EditRecord
{
    protected static string $resource = ClientResource::class;
    protected static ?string $title = 'Body & Display';
    protected static ?string $navigationIcon = 'heroicon-m-squares-2x2';
    protected static ?string $navigationLabel = '🏪 Body & Display';

    public function form(Form $form): Form
    {
        return $form->schema(
            StorefrontBodyTab::schema()
        );
    }
