...
class EditIntegrations extends EditRecord
{
    ...
    protected static ?string $title = 'Integrations & Social';
    protected static ?string $navigationIcon = 'heroicon-m-share';

    public function form(Form $form): Form
    {
        return $form->schema(
            IntegrationsTab::schema()
        );
    }
            ...
            public static function canAccess(array $parameters = []): bool
    {
        ...
        if ($client) {
            ...
            if ($client->plan) {
                ...
                if (is_array($planHiddenMenus) && in_array('integrations', $planHiddenMenus)) {
            ...
            if (is_array($hiddenMenus) && in_array('integrations', $hiddenMenus)) {
                return false; // Menu is hidden specifically for this client
            }
        }

        if ($user->role === 'staff') {
            return $user->hasStaffPermission('manage_integrations');
        }
