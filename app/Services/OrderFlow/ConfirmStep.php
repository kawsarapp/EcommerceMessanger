...
class ConfirmStep implements OrderStepInterface
{
    ...
    public function process(OrderSession $session, string $userMessage, ?string $imageUrl = null): array
    {
        ...
        // ✅ ৭. ফাইনাল কনফার্মেশন চেক & অর্ডার তৈরি (UPDATED)
        if ($this->isPositiveConfirmation($userMessage)) {
            ...
            // কাস্টমার যদি "অর্ডার নম্বর কত" বলে, তার মানে সে কনফার্ম, তাই অর্ডার বানিয়ে দাও।
            return [
                'action' => 'create_order', 
    ...
    /**
     * ✅ পজিটিভ কিওয়ার্ড চেক (UPDATED with 'Order Number')
     */
    private function isPositiveConfirmation($msg)
    {
        $words = [
            ...
            // 🔥 নতুন যোগ করা কিওয়ার্ড যা অর্ডার তৈরির ট্রিগার হিসেবে কাজ করবে
